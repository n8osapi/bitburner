...
if (!sidebar){
  sidebar = doc.body.appendChild(elemFromHTML(`<div class="sb"><style>${css}</style><div class="head"><a class="icon lr"></a><span class=title>box.sidebar v1.0</span></div>`));
